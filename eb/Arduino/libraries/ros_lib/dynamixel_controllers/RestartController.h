...
static const char RESTARTCONTROLLER[] = "dynamixel_controllers/RestartController";
  ...
  class RestartControllerRequest : public ros::Msg
  {
    ...
    RestartControllerRequest():
      ...
      class_name(""),
      controller_name(""),
      dependencies_length(0), st_dependencies(), dependencies(nullptr)
    {
    }
    ...
    virtual const char * getType() override { return RESTARTCONTROLLER; };
    virtual const char * getMD5() override { return "7785d708c83a180befd2fe3450dd9d41"; };
