...
# Generic slider gui for tuning servo timings, etc.
...
robotpose = RobotPose("debug_sliders")

pub_val1  = rospy.Publisher('/slider/value1',  Float32, queue_size=1)
pub_val2  = rospy.Publisher('/slider/value2',  Float32, queue_size=1)
pub_val3  = rospy.Publisher('/slider/value3',  Float32, queue_size=1)
pub_val4  = rospy.Publisher('/slider/value4',  Float32, queue_size=1)
pub_val5  = rospy.Publisher('/slider/value5',  Float32, queue_size=1)
pub_val6  = rospy.Publisher('/slider/value6',  Float32, queue_size=1)
pub_val7  = rospy.Publisher('/slider/value7',  Float32, queue_size=1)
pub_val8  = rospy.Publisher('/slider/value8',  Float32, queue_size=1)
pub_val9  = rospy.Publisher('/slider/value9',  Float32, queue_size=1)
pub_val10 = rospy.Publisher('/slider/value10', Float32, queue_size=1)
pub_val11 = rospy.Publisher('/slider/value11', Float32, queue_size=1)
pub_val12 = rospy.Publisher('/slider/value12', Float32, queue_size=1)
pub_mode  = rospy.Publisher('/slider/button', Int32, queue_size=1)
...
layout = [
    [
        ...
        sg.Button("P0",  enable_events=True, key='-POSE0-', pad=(1,0)),
        sg.Button("P1",  enable_events=True, key='-POSE1-', pad=(1,0)),
        sg.Button("P2",  enable_events=True, key='-POSE2-', pad=(1,0)),
        sg.Button("P3",  enable_events=True, key='-POSE3-', pad=(1,0)),
        sg.Button("P4",  enable_events=True, key='-POSE4-', pad=(1,0)),
        sg.Button("STOP",enable_events=True, key='-STOP-',  pad=(1,0)),
        sg.Button("GO",  enable_events=True, key='-GO-',    pad=(1,0)),
        #sg.Text('', size=(1, 1), expand_x=False, ),
        sg.Button("RST", enable_events=True, key='-RST-ALL-', pad=(1,0) ), 
    ],
    
    # Slider 1 (shown with some options)
    [    
        sg.Text('Sleep tm', size=(12, 1), expand_x=False, justification='left',
    ...
    # Slider 2
    [    
        sg.Text('Lean amt', size=(12, 1), expand_x=False, justification='left', ), 
    ...
    # Slider 3
    [    
        sg.Text('Servo sp', size=(12, 1), expand_x=False, justification='left', ), 
    ...
    # Slider 4
    [    
        sg.Text('Slider 4', size=(12, 1), expand_x=False, justification='left', ), 
    ...
    # Slider 5
    [    
        sg.Text('Slider 5', size=(12, 1), expand_x=False, justification='left', ), 
    ...
    # Slider 6
    [    
        sg.Text('Slider 6', size=(12, 1), expand_x=False, justification='left', ), 
        sg.Slider(key='-SL6-', range=(-100, 100), default_value=val6, 
            enable_events=True, orientation='horizontal', expand_x=True, ),
    ...
    # Slider 7
    [    
        sg.Text('Slider 7', size=(12, 1), expand_x=False, justification='left', ), 
        sg.Slider(key='-SL7-', range=(0, 100), default_value=val7, 
            enable_events=True, orientation='horizontal', expand_x=True, ),
    ...
    # Slider 8
    [    
        sg.Text('Slider 8', size=(12, 1), expand_x=False, justification='left', ), 
        sg.Slider(key='-SL8-', range=(0, 100), default_value=val8, 
            enable_events=True, orientation='horizontal', expand_x=True, ),
    ...
    # Slider 9
    [    
        sg.Text('Slider 9', size=(12, 1), expand_x=False, justification='left', ), 
        sg.Slider(key='-SL9-', range=(0, 200), default_value=val9, 
            enable_events=True, orientation='horizontal', expand_x=True, ),
    ...
    # Slider 10
    [    
        sg.Text('Slider 10', size=(12, 1), expand_x=False, justification='left', ), 
        sg.Slider(key='-SL10-', range=(0, 200), default_value=val10, 
            enable_events=True, orientation='horizontal', expand_x=True, ),
    ...
    # Slider 11
    [    
        sg.Text('Slider 11', size=(12, 1), expand_x=False, justification='left', ), 
        sg.Slider(key='-SL11-', range=(-0, 1000), default_value=val11, 
            enable_events=True, orientation='horizontal', expand_x=True, ),
    ...
    # Slider 12
    [    
        sg.Text('Slider 12', size=(12, 1), expand_x=False, justification='left', ), 
        sg.Slider(key='-SL12-', range=(-0, 1000), default_value=val12, 
            enable_events=True, orientation='horizontal', expand_x=True, ),
...
window = sg.Window('Debug Sliders', layout, size=(600, 650), element_justification='l', finalize=True)

def battery_callback(data):
    #print("Battery Callback executing")
