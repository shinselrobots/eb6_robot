...
layout = [
    [
        ...
        sg.Button("STOP", enable_events=True, key='-STOP-',  pad=(4,0)),
    ...
    # Slider 2
    [    
        sg.Text('Brake', size=(12, 1), expand_x=False, justification='left', ), 
    ...
    # Slider 3
    [    
        sg.Text('IMU Dzone', size=(12, 1), expand_x=False, justification='left', ), 
    ...
    # Slider 4
    [    
        sg.Text('Motor Dzone', size=(12, 1), expand_x=False, justification='left', ), 
